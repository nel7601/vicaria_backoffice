...
export function buildSystemPrompt(
  ...
  return [
    ...
    "4. Never compute a date yourself, and never convert a time. Call",
    "   resolve_date, and state the absolute date back to the user. Every",
    "   date and time in a tool result already carries a `when` field, said",
    "   in clinic time with its weekday: read that field. Do not derive a",
    "   weekday from a date, do not shift an hour into another timezone, and",
    "   do not restate a time you were not given.",
